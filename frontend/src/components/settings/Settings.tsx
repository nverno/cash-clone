...
import { formatBalance, formatInitial, formatName, formatPhoneNumber, formatUsername } from '../../utils';
    ...
    <div className="layout-edit-settings flex-container flex-v flex-fill">
      <div className="edit-settings-header theme-white theme-bg">
        <div className="customer-profile-simple">
          <i style={{ backgroundColor: '#FB60C4' }}
          ...
          </i>      <h3 className="display-name display-name-with-icon">
            <span className="name ">{formatName(user)}</span>
          </h3>
          <h3 className="cashtag"><a href={user.cashTag}>{user.cashTag}</a></h3>
        </div>

        <a data-link-label="Settings Notifications"
          href="#"
          className="notification-prefs">
          <span className="display-text show-at-sm">
            Notifications
          </span>
          <div
        ...
        <div className="config-column funding-items">
          ...
          <div>
            <div className="account-module-container instruments-container">
              ...
              <div className="instrument-item settings-display-field settings-instrument-item debit-card"><i className="instrument-icon">
          ...
          <div className="legal-links">
            <a href="https://cash.app/legal/tos"
              rel="noopener noreferrer"
              target="_blank">  Legal
            </a>
            <a href="https://squareup.com/legal/privacy" rel="noopener noreferrer" target="_blank">  Privacy
            </a>
